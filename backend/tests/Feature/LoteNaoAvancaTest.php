...
class LoteNaoAvancaTest extends TestCase
{
    use RefreshDatabase;

    public function test_lote_permanece_em_andamento_quando_producao_insuficiente(): void
    {
        ...
        // 2 pilhas finalizadas: 90+90 = 180
        foreach ([2, 3] as $pilha) {
        ...
        // Finalizar com 30 → 180+30 = 210 < 300 → permanece em_andamento
        $this->actingAs($user, 'sanctum')
